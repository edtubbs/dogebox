  ...
  libdogecoin-optee-host = super.stdenv.mkDerivation rec {
    ...
    buildPhase = ''
      ...
      make \
        ...
        CFLAGS="-std=gnu89 -D_GNU_SOURCE -fpermissive -I${self.libdogecoin-optee-host-libs}/include -I${self.libdogecoin-optee-host-libs}/include/dogecoin -I${super.optee-client.dev}/include -I${super.yubikey-personalization}/include/ykpers-1 -I${super.libusb1}/include -I${super.libyubikey}/include -I$HOME/src/optee/ta/include"
    '';
    installPhase = ''
      mkdir -p $out/bin
